...
import { ProductQuantityChange } from "app/model/product-creation";
...
describe('Product Item Component', () => {
  ...
  it('should handle quantity increment correctly', () => {
    ...
    const decrButtonEl = fixture.debugElement.query(By.css('.decrement'));
  ...
  it('should handle quantity decrement correctly', () => {
    ...
    const incrButtonEl = fixture.debugElement.query(By.css('.increment'));
