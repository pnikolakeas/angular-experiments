...
@Component({
  ...
  template: `
    ...
    <hr/>
    <app-create-product (productCreation)="onProductCreation($event)"></app-create-product>
  `,
  styles: []
})
export class ProductListComponent implements OnInit {
  ...
  onProductCreation(productCreation: ProductCreation) {
    this.products.push(productCreation.product);
  }
}
